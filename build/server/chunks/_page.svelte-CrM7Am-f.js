import { T as copy_payload, V as assign_payload, x as pop, _ as rest_props, v as push, X as fallback, a9 as store_set, a3 as spread_attributes, a1 as attr, W as slot, a7 as ensure_array_like, Y as bind_props, a2 as store_get, a5 as unsubscribe_stores, Z as sanitize_slots, w as setContext, a0 as sanitize_props, a4 as escape_html, $ as spread_props, a8 as getContext, aa as stringify } from './index-Cn6ulO8r.js';
import './client-CnCRRyPd.js';
import { C as Close, B as Button, i as isSideNavCollapsed, b as isSideNavRail, S as Select, a as SelectItem, W as WarningFilled, c as WarningAltFilled } from './navStore-DU5uLLqM.js';
import { w as writable, r as readable } from './index3-DvSXqmVe.js';
    ...
    Content($$payload2, {
      children: ($$payload3) => {
        ...
        if (teamsArray.length > 0) {
          ...
          Grid($$payload3, {
            children: ($$payload4) => {
              const each_array = ensure_array_like(teamsArray);
              $$payload4.out += `<!--[-->`;
              for (let $$index_2 = 0, $$length = each_array.length; $$index_2 < $$length; $$index_2++) {
                let teams = each_array[$$index_2];
                Row($$payload4, {
                  children: ($$payload5) => {
                    Column($$payload5, {
                      children: ($$payload6) => {
                        const each_array_1 = ensure_array_like(teams.team1);
                        $$payload6.out += `<h2>Equipo 1</h2> <!--[-->`;
                        for (let $$index = 0, $$length2 = each_array_1.length; $$index < $$length2; $$index++) {
                          let player2 = each_array_1[$$index];
                    ...
                    Column($$payload5, {
                      children: ($$payload6) => {
                        const each_array_2 = ensure_array_like(teams.team2);
                        $$payload6.out += `<h2>Equipo 2</h2> <!--[-->`;
                        for (let $$index_1 = 0, $$length2 = each_array_2.length; $$index_1 < $$length2; $$index_1++) {
                          let player2 = each_array_2[$$index_1];
                          $$payload6.out += `<p>${escape_html(player2.name)}</p>`;
                        }
...
//# sourceMappingURL=_page.svelte-CrM7Am-f.js.map
