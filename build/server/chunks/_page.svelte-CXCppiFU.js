import { X as copy_payload, Y as assign_payload, t as pop, a0 as rest_props, p as push, Z as fallback, ac as store_set, a6 as spread_attributes, a4 as attr, a2 as slot, aa as ensure_array_like, _ as bind_props, a5 as store_get, a8 as unsubscribe_stores, $ as sanitize_slots, q as setContext, a3 as sanitize_props, a7 as escape_html, ab as getContext, V as writable, a1 as spread_props, ad as stringify, W as readable } from './index-B23-R4wG.js';
import './exports-CHdH9QCl.js';
import './state.svelte-B1x1JptK.js';
import { C as Close, B as Button, S as Select, W as WarningFilled, b as WarningAltFilled, i as isSideNavCollapsed, c as isSideNavRail, a as SelectItem } from './navStore-DRcDAsAO.js';
      ...
      children: ($$payload3) => {
              ...
              for (let $$index_2 = 0, $$length = each_array.length; $$index_2 < $$length; $$index_2++) {
                  ...
                  children: ($$payload5) => {
                    Column($$payload5, {
                      children: ($$payload6) => {
                        ...
                        $$payload6.out += `<h2>Equipo A</h2> <!--[-->`;
                        for (let $$index = 0, $$length2 = each_array_1.length; $$index < $$length2; $$index++) {
                          let player = each_array_1[$$index];
                          $$payload6.out += `<p>${escape_html(player.name)}</p>`;
                        }
                        $$payload6.out += `<!--]--> <br> <br> <p><strong>Porcentaje de Victorias: ${escape_html(parseInt(teams.teamA.reduce((acc, curr) => acc + curr.victoryPercentage, 0) / teams.teamA.length))} %</strong></p>`;
                      },
                      $$slots: { default: true }
                    });
                    $$payload5.out += `<!----> `;
                    Column($$payload5, {
                      children: ($$payload6) => {
                        ...
                        $$payload6.out += `<h2>Equipo B</h2> <!--[-->`;
                        for (let $$index_1 = 0, $$length2 = each_array_2.length; $$index_1 < $$length2; $$index_1++) {
                          let player = each_array_2[$$index_1];
                          $$payload6.out += `<p>${escape_html(player.name)}</p>`;
                        }
                        $$payload6.out += `<!--]--> <br> <br> <p><strong>Porcentaje de Victorias: ${escape_html(parseInt(teams.teamB.reduce((acc, curr) => acc + curr.victoryPercentage, 0) / teams.teamB.length))} %</strong></p>`;
                      },
                      $$slots: { default: true }
                    });
                    $$payload5.out += `<!---->`;
                ...
                Row($$payload4, {
                  children: ($$payload5) => {
                    Column($$payload5, {
                      children: ($$payload6) => {
                        NumberInput($$payload6, { label: "Goles Equipo A", min: 0 });
                      },
                      $$slots: { default: true }
                    });
                    $$payload5.out += `<!----> `;
                    Column($$payload5, {
                      children: ($$payload6) => {
                        NumberInput($$payload6, { label: "Goles Equipo B", min: 0 });
                      },
                      $$slots: { default: true }
                    });
                    $$payload5.out += `<!---->`;
                    ...
                    Column($$payload5, {
                      children: ($$payload6) => {
                        Button($$payload6, {
                          ...
                          children: ($$payload7) => {
                            $$payload7.out += `<!---->Registrar resultado`;
                          },
                          $$slots: { default: true }
                        });
                      },
        ...
        DataTable($$payload3, {
          ...
          headers: [
            ...
            {
              key: "victoryPercentage",
              value: "Porcentaje victorias"
            },
...
//# sourceMappingURL=_page.svelte-CXCppiFU.js.map
